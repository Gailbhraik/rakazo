...
/** Raccourcis de l'accueil vers les panneaux de réglage et les pages de l'hôte. */
const TOOLS = [
  {
...
export function HomePage() {
  ...
  return (
    <div className="rk-home h-full overflow-y-auto" data-testid="home-page">
      <main className="mx-auto w-full max-w-[1760px] px-5 pb-12 pt-8 sm:px-8 sm:pt-12 xl:px-12">
        ...
        {/*
          Sur grand écran, une seule colonne laissait d'immenses marges vides :
          l'accueil passe en deux colonnes, l'essentiel à gauche et un panneau
          (météo, crédits, nouveautés) à droite. Sur téléphone, les deux
          colonnes s'effacent (`contents`) et `order` rétablit l'ordre de
          lecture d'origine : météo, activité, crédits, accès, nouveautés, bots.
        */}
        <div className="flex flex-col xl:grid xl:grid-cols-[minmax(0,1fr)_minmax(320px,380px)] xl:items-start xl:gap-10">
          <div className="contents xl:block xl:min-w-0">
            <section aria-labelledby="today-title" className="order-2 mb-8 xl:order-none">
            ...
            <section aria-labelledby="tools-title" className="order-4 mb-8 xl:order-none">
            ...
            <section aria-labelledby="bots-title" className="order-6 xl:order-none">
          ...
          <aside aria-label="Panneau latéral" className="contents xl:block">
            <div className="order-1 xl:order-none">
              <WeatherWidget />
            </div>
            <section aria-labelledby="credits-title" className="order-3 mb-8 xl:order-none">
            ...
            <Link to="/models/new" className="rk-home-bot order-5 mb-8 xl:order-none">
