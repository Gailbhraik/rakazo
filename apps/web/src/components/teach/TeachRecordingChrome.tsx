...
export function TeachRecordingChrome({
  ...
  if (variant === "overlay") {
    return (
      ...
      >
        <div className="truncate text-[13px] text-[var(--rk-n08)]">
          <Trans>Recording: {recording.goal}</Trans>
        </div>
        <div className="text-[12px] text-[var(--rk-n29)]">
  ...
  return (
    <div
      ...
      className="rounded-[11px] border border-[var(--rk-n66)] bg-[var(--rk-n92)] px-3 py-3"
    >
      <div className="text-[14px] text-[var(--rk-n08)]">
        <Trans>Recording: {recording.goal}</Trans>
      </div>
