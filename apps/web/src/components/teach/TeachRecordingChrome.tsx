...
export function TeachRecordingChrome({
  ...
  if (variant === "overlay") {
    return (
      ...
      >
        <div className="truncate text-[13px] text-[#EEECEC]">
          <Trans>Recording: {recording.goal}</Trans>
        </div>
        <div className="text-[12px] text-[#967E79]">
  ...
  return (
    <div
      ...
      className="rounded-[11px] border border-[#2B201E] bg-[#161110] px-3 py-3"
    >
      <div className="text-[14px] text-[#EEECEC]">
        <Trans>Recording: {recording.goal}</Trans>
      </div>
