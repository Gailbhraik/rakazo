...
export function AskCard({
  ...
  return (
    <div className="max-w-[74%] rounded-[20px] border border-[var(--rk-n64)] bg-[var(--rk-n88)] px-5 py-[17px]">
      <div className="text-[15.5px] leading-[1.5] text-[var(--rk-n08)]">
        <ChatMarkdown>{block.text}</ChatMarkdown>
      </div>
      {block.detail ? (
        <pre className="mt-3 max-h-72 overflow-auto whitespace-pre-wrap break-words rounded-xl bg-[var(--rk-n94)] px-3.5 py-3 font-mono text-[12.5px] leading-[1.7] text-[var(--rk-n29)]">
          {block.detail}
        </pre>
      ) : null}
      {block.status === "answered" ? (
        ...
        <div className="mt-3.5 text-[13.5px] font-medium text-[var(--rk-n29)]">
            ...
            <button
              ...
              className={
                approvalActions && action.id === "allow"
                  ? "rounded-[11px] bg-[var(--rk-n06)] px-[17px] py-2 text-[14.5px] font-medium text-[var(--rk-n83)] disabled:opacity-50"
                  : "rounded-[11px] border border-[var(--rk-n62)] px-[17px] py-2 text-[14.5px] text-[var(--rk-n18)] disabled:opacity-50"
              }
            >
        ...
        >
          <input
            ...
            placeholder={t`Code`}
            className="rounded-[11px] border border-[var(--rk-n51)] bg-[var(--rk-n94)] px-3.5 py-2.5 text-[14.5px] text-[var(--rk-n08)] outline-none focus:border-[var(--rk-n37)]"
          />
          <button
            type="submit"
            disabled={(secretInput ? answer.length === 0 : !answer.trim()) || submitting}
            className="self-start rounded-[11px] bg-[var(--rk-n06)] px-[17px] py-2 text-[14.5px] font-medium text-[var(--rk-n83)] disabled:opacity-50"
          >
        ...
        >
          ...
          <div className="flex gap-2">
            <button
              ...
              className="rounded-[11px] bg-[var(--rk-n06)] px-[17px] py-2 text-[14.5px] font-medium text-[var(--rk-n83)] disabled:opacity-50"
            >
            ...
            <button
              ...
              className="rounded-[11px] border border-[var(--rk-n62)] px-[17px] py-2 text-[14.5px] text-[var(--rk-n18)] disabled:opacity-50"
            >
              <Trans>Cancel</Trans>
            </button>
          </div>
      ...
      {error ? <p className="mt-3 text-[13px] text-[var(--rk-a14)]">{error}</p> : null}
    </div>
  );
}
